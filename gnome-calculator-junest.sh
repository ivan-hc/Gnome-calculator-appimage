...
SHARESAVED="y" # Enter here keywords or file/directory names to save in both /usr/share and /usr/lib
...
LIBSAVED="libEGL libgtk- $lib_browser_launcher" # Enter here keywords or file/directory names to save in /usr/lib
